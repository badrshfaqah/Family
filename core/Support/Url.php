...
final class Url
{
    ...
    /**
     * رابط قياسي نظيف للمسارات الرقمية: /calendar/4
     * قصير وقابل للمشاركة بدون أي ترميز رموز (لا تظهر %XX عند النسخ)،
     * وأي صيغة قديمة بلاحقة عنوان تتحول له بتحويل 301 من صفحات العرض.
     * الكلمات المفتاحية تصل محركات البحث عبر العناوين والأوصاف والبيانات المنظمة.
     */
    public static function pretty(string $route, int $id, string $title): string
    {
        return self::to($route . '/' . $id);
    }
