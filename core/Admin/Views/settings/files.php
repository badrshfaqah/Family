...
<form method="post" action="<?= Url::admin('settings/files/save') ?>" class="card-box">
  ...
  <p class="form-hint">الامتدادات الأساسية المسموحة دائمًا: jpg, jpeg, png, webp, gif, pdf, doc, docx, xls, xlsx, mp3, mp4. امتدادات الويب النشطة مثل HTML وSVG وJS وPHP مرفوضة دائمًا.</p>
